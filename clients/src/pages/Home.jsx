...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-transparent backdrop-blur-xl scrollbar-hide z-10 h-[100vh]  lg:w-[90%] lg:mx-auto overflow-y-hidden shadow-2xl rounded-xl m-3">

        <div className='flex'>
          {
            !showProfile ?
            <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-transparent relative">

                <div className='h-[61px] px-4 border border-white rounded-xl mb-2 backdrop-blur-xl'>
                  <div className='flex'>
                    <a className='flex items-center relative  -top-4 block h-[90px]' href='/'>

                      <h3 className='text-[20px] text-white font-body font-extrabold tracking-wider'>Messages</h3>
                    </a>
                  </div>
                  <div className='absolute top-4 right-5 flex items-center gap-x-3'>
                    ...
                    <div className={`${showNotifications ? "overflow-y-scroll scrollbar-hide tracking-wide absolute top-10 -left-32 z-10 w-[240px] bg-[#fafafa] px-4 py-2 shadow-2xl" : "hidden"}`}>
                      <div className='text-[13px]'>
                        ...
                        {!notifications.length && "No bg-transparent backdrop-blur-xl rounded-2xl p-4 absolutemessages"}
                      </div>
                      {
                        notifications.map((e, index) => {
                          return (
                            ...
                            }} key={index} className='text-[12.5px] text-white px-2 cursor-pointer' >
                ...
                <div className='border border-white p-3 rounded-xl backdrop-blur-xl'>

                  <div className='-mt-6 relative pt-6 px-4'>
                    <form onSubmit={(e) => e.preventDefault()}>

                      <input onChange={handleSearch} className='w-[99.5%] bg-[#f6f6f6] text-white tracking-wider pl-9 py-[8px] rounded-[9px] outline-0' type="text" name="search" placeholder="Search" />
                  ...
                  <Webcam className='border border-white ml-[4.5rem] mt-6 rounded-2xl absolute h-36 ' />
                
                </div>
              {/* <div className='border border-white p-4 backdrop-blur-xl bg-red-400'> */}
          ...
          <Chat className="chat-page relative lg:w-[100%] h-[100vh] bg-transparent" />
